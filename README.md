...
|---|---|---|
| Salcedo Champi, Matias Rodolfo | Investigó los fundamentos de Domain-Driven Design estratégico (EventStorming, Context Mapping y Bounded Context Canvases) a partir de la bibliografía de Vaughn Vernon y Nick Tune, y los aplicó en la consolidación del modelo de dominio de CareConnect. En el Avance 4 (Sprint 3) participó en el diseño y ejecución de las entrevistas de validación del producto con usuarios representativos. | La sistematización del modelado estratégico mediante DDD permitió tomar decisiones de arquitectura fundamentadas y trazables, y complementarlas validando el MVP con usuarios reales. |
| Santillan Alvarado, Melina Liz | Profundizó en técnicas de Lean UX y Needfinding, aplicándolas en el diseño y análisis de entrevistas con cuidadores y pacientes geriátricos, y consolidó las User Personas y el Empathy Map. En el Avance 4 (Sprint 3) trabajó en el cierre e integración final de la aplicación en Flutter, unificando componentes y estados vacíos con las guías de estilo del producto. | La actualización en métodos centrados en el usuario permitió construir hipótesis de producto validadas con datos reales y llevarlas hasta una interfaz final coherente y consistente. |
...
| Osores Marchese, Pietro | Investigó arquitectura C4 Model y la herramienta Structurizr para representar los diagramas de contexto, container y deployment de CareConnect, y estudió las capas tácticas de DDD (Aggregate Root; Domain, Application, Infrastructure e Interface). En el Avance 4 (Sprint 3) aplicó estos conocimientos al finalizar los módulos de Documentos, Gestión de Consentimiento y Diario de Seguimiento, y al ajustar el despliegue del backend. | La aplicación del C4 Model y de las capas tácticas de DDD permitió comunicar la arquitectura con consistencia y guiar la implementación de los módulos finales del producto. |
...
| Integrante | Acciones realizadas | Conclusiones |
|---|---|---|
| Salcedo Champi, Matias Rodolfo | Identificó vacíos en privacidad de datos clínicos y consentimiento informado, y consultó documentación de la Ley N° 29733 (Ley de Protección de Datos Personales del Perú) y lineamientos OMS sobre adherencia a tratamientos. En el Avance 4 (Sprint 3) recogió, durante las entrevistas de validación, la percepción de los usuarios sobre el manejo de su información. | La normativa de datos personales evoluciona, y el equipo debe mantenerse alineado a lo largo del ciclo de vida del producto, contrastándola con la percepción real de los usuarios. |
| Santillan Alvarado, Melina Liz | Reconoció la necesidad de profundizar en accesibilidad WCAG y diseño inclusivo para adultos mayores, consultando guías oficiales de la W3C. En el Avance 4 (Sprint 3) aplicó estos principios al cierre visual e integración final de la aplicación en Flutter. | El diseño inclusivo no es un complemento, sino un requisito que se aprende y refuerza permanentemente en proyectos de salud, y que debe reflejarse en la interfaz final del producto. |
| Nikaido Vargas, Javier Masaru | Identificó necesidad de capacitarse en mensajería asíncrona y eventos de dominio para desacoplar Agenda de Notificaciones; consultó documentación de Spring Events y patrones de Vernon, y reforzó su dominio de testing automatizado con JUnit 5 y Mockito. En el Avance 4 (Sprint 3) continuó validando la integración de los servicios core del backend para la versión final del producto. | El aprendizaje permanente sobre patrones de integración y testing es clave para diseñar sistemas que escalen y asegurar su correcto funcionamiento en la entrega final. |
...
| **Location** | Sesión remota vía Discord y coordinación complementaria por WhatsApp |
| **Prepared By** | Salcedo Champi, Matias Rodolfo |
| **Attendees (to planning meeting)** | Salcedo Champi, Matias Rodolfo · Santillan Alvarado, Melina Liz · Nikaido Vargas, Javier Masaru · Osores Marchese, Pietro |
...
| 3 | US03 | Reprogramar evento de salud | T-US03-03: Ajustar flujo de reprogramación de eventos | Agregar opción de edición/reprogramación de eventos con validación de campos obligatorios. | 3 | Salcedo Champi, Matias Rodolfo | Done |
...
| 3 | US12 / US13 | Diario de seguimiento | T-DIA-03: Completar diario para paciente y cuidador | Finalizar creación, visualización y consulta de notas del diario de seguimiento. | 4 | Osores Marchese, Pietro | Done |
...
|---|---|---|---:|
| Salcedo Champi, Matias Rodolfo | Frontend Developer / UI Integration | Finalización de pantallas principales, home del paciente, reprogramación de eventos de Agenda y ajustes de consistencia visual. | 10 |
...
| Osores Marchese, Pietro | Frontend Developer / Documentation | Cierre de Documentos, Gestión de Consentimiento, perfil compartido, Diario de seguimiento y actualización de evidencias. | 12 |
