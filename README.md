...
| ------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1       | 21/04/2026 | Salcedo Champi, Matias Rodolfo; Santillan Alvarado, Melina Liz; Costa Morales, Christofer William; Nikaido Vargas, Javier Masaru; Osores Marchese, Pietro | Avance 1: En esta primera entrega se avanzó con los capítulos 1, 2 y 3 de forma organizada para iniciar el proyecto de CareStacks, estableciendo la idea del producto, el estudio del contexto y las features principales del sistema.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 2       | 15/05/2026 | Salcedo Champi, Matias Rodolfo; Santillan Alvarado, Melina Liz; Costa Morales, Christofer William; Nikaido Vargas, Javier Masaru; Osores Marchese, Pietro | Avance 2: Se completaron las secciones faltantes del Capítulo 3, incluyendo Style Guidelines con paleta y tipografía, Information Architecture y Landing Page UI Design con wireframe y mockup. Además, se desarrolló el Capítulo 4 con la configuración del entorno de desarrollo, gestión del código fuente, convenciones de estilo, configuración de despliegue y el Sprint 1 completo, incluyendo Planning, Backlog, evidencia de desarrollo con commits reales de los repositorios BackEnd, FrontEnd, Landing Page y Report, evidencia de testing y ejecución, documentación de los 46 endpoints REST y collaboration insights. También se actualizaron los Insights de colaboración, se añadieron los objetivos SMART, se reescribió el Student Outcome por integrante, se incorporaron las fuentes de la problemática, las Spike Stories, los Bounded Context Canvases como imágenes y se completaron el Glosario, la Bibliografía y los Anexos. Finalmente, se renombró el BC5 a Gestión de Consentimiento, se unificaron los nombres de los bounded contexts y se ajustó el diagrama de container a un Backend único. |
| 3       | 21/06/2026 | Salcedo Champi, Matias Rodolfo; Santillan Alvarado, Melina Liz; Costa Morales, Christofer William; Nikaido Vargas, Javier Masaru; Osores Marchese, Pietro | Avance 3: Se trabajaron y documentaron los endpoints correspondientes a la gestión de permisos y a la gestión de costos, fortaleciendo la funcionalidad del sistema desde el BackEnd. Asimismo, se avanzó con el desarrollo visual de la aplicación móvil de CareStacks en Flutter, incluyendo la estructuración de pantallas, navegación, componentes visuales, diseño de interfaces, organización del flujo de usuario y adaptación del estilo gráfico definido previamente para mantener coherencia con la identidad del producto. Además, se integraron mejoras en la experiencia de usuario, distribución visual de elementos, uso de colores, tipografías y componentes reutilizables dentro de la app móvil.                                                                                                                                                                                                                                                                                                                                                                                                            |
| 4       | 04/07/2026 | Salcedo Champi, Matias Rodolfo; Santillan Alvarado, Melina Liz; Costa Morales, Christofer William; Nikaido Vargas, Javier Masaru; Osores Marchese, Pietro | Avance 4: Se desarrolló y documentó el Sprint 3, orientado a cerrar el avance funcional de la aplicación móvil CareConnect. Durante este Sprint se finalizó al 100% la aplicación, integrando los flujos principales de paciente y cuidador: autenticación, agenda, notificaciones, documentos médicos, diario de seguimiento, perfil compartido y gestión de consentimiento. Además, se realizaron ajustes de navegación, consistencia visual, validación de integración con el backend, pruebas finales de ejecución y entrevistas de validación con usuarios representativos de los segmentos objetivo. Finalmente, se actualizó el Capítulo IV con evidencias de desarrollo, testing, despliegue, colaboración del equipo y resultados de validación del producto. |
...
### 4.2.3. Sprint 3 <a id="423-sprint-3"></a>

El Sprint 3 corresponde al tercer ciclo de desarrollo de **CareConnect** y representa el avance final de implementación dentro del alcance del trabajo final. Mientras que el Sprint 1 permitió establecer la base técnica del producto y el Sprint 2 se orientó a completar el backend, desarrollar las pantallas principales del cuidador e iniciar la integración entre la aplicación móvil y los servicios REST, el Sprint 3 se enfocó en cerrar la experiencia completa de uso para los dos segmentos objetivo: pacientes geriátricos y cuidadores.

En este Sprint, el equipo trabajó en la finalización al 100% de la aplicación móvil, consolidando los flujos principales de autenticación, agenda, notificaciones, documentos médicos, diario de seguimiento, perfil compartido y gestión de consentimiento. Además, se realizaron ajustes de navegación, mejoras visuales, validaciones de integración y pruebas finales para asegurar que la aplicación pueda ser presentada como un MVP funcional y coherente con los requerimientos definidos en el Product Backlog.
...
#### 4.2.3.1. Sprint Planning 3 <a id="4231-sprint-planning-3"></a>

El Sprint Planning 3 se realizó con el objetivo de definir el alcance final de implementación y validación de CareConnect. Luego de revisar los avances obtenidos en el Sprint 2, el equipo identificó que la prioridad era cerrar las pantallas faltantes, completar los flujos del paciente, reforzar la navegación general de la aplicación y preparar una versión estable para realizar entrevistas de validación.

Durante la planificación, el equipo acordó que el Sprint 3 debía entregar un avance visible, funcional y validable: una aplicación móvil terminada al 100% dentro del alcance académico, conectada con los servicios principales del backend, con evidencias de ejecución y con retroalimentación obtenida mediante entrevistas de validación.

| Sprint Planning |  |
|---|---|
| **Sprint #** | 3 |
| **Sprint Planning Background** | El Sprint 2 permitió finalizar el backend, desarrollar las pantallas principales del cuidador e iniciar la integración entre Flutter y los servicios REST. Para el Sprint 3, el equipo priorizó el cierre funcional de la aplicación móvil, la integración de los flujos del paciente y cuidador, los ajustes de navegación, las pruebas finales y la validación con usuarios. |
| **Date** | 2026-06-24 |
| **Time** | 20:00 – 22:00 (UTC-5) |
| **Location** | Sesión remota vía Discord y coordinación complementaria por WhatsApp |
| **Prepared By** | Salcedo Champi, Matias Rodolfo |
| **Attendees (to planning meeting)** | Salcedo Champi, Matias Rodolfo · Santillan Alvarado, Melina Liz · Costa Morales, Christofer William · Nikaido Vargas, Javier Masaru · Osores Marchese, Pietro |
| **Sprint 2 Review Summary** | En el Sprint 2 se logró cerrar el backend, documentar los servicios principales, avanzar con las pantallas del cuidador en Flutter y conectar la aplicación móvil con los endpoints REST desplegados. Esto permitió contar con una primera experiencia funcional orientada al seguimiento del paciente desde el rol cuidador. |
| **Sprint 2 Retrospective Summary** | El equipo identificó como aciertos la integración temprana con el backend y el enfoque en un segmento específico. Como oportunidad de mejora, se detectó la necesidad de completar los flujos del paciente, uniformizar la experiencia visual, revisar la navegación entre módulos y validar el producto con usuarios reales antes del cierre del informe. |
| **Sprint Goal** | Finalizar al 100% la aplicación móvil CareConnect dentro del alcance académico, integrando los flujos principales de paciente y cuidador, validando la conexión con el backend desplegado y realizando entrevistas de validación para evaluar la utilidad y facilidad de uso del MVP. |
| **Sprint Velocity** | 34 Story Points |
| **Sum of Story Points** | 34 |

**Sprint Goal redactado con enfoque de producto:**

Nuestro foco está en entregar una versión funcional completa de CareConnect que permita a pacientes geriátricos y cuidadores interactuar con los módulos principales de la aplicación. Creemos que esto aporta valor porque transforma el avance técnico del Sprint 2 en una experiencia más completa, donde ambos roles pueden consultar información, registrar actividades, visualizar recordatorios, gestionar documentos y compartir el seguimiento del cuidado.

Esto se confirmará cuando la aplicación permita navegar por los flujos principales sin pantallas incompletas, cuando los módulos estén conectados de forma consistente con la estructura del backend y cuando las entrevistas de validación permitan recoger comentarios sobre comprensión, utilidad y facilidad de uso.

**Definition of Done acordada para el Sprint 3:**

- La aplicación móvil cuenta con los flujos principales de paciente y cuidador implementados.
- Las pantallas de Agenda, Notificaciones, Documentos, Diario, Perfil y Gestión de Consentimiento están integradas a la navegación principal.
- Las pantallas finales mantienen consistencia visual con las guías de estilo definidas en el Capítulo III.
- La aplicación consume o simula de forma controlada la información proveniente del backend, según el módulo correspondiente.
- Los errores de navegación, campos vacíos y estados sin información se manejan con mensajes claros.
- Los endpoints principales se encuentran disponibles y documentados en Swagger/OpenAPI.
- Se ejecutan pruebas finales de navegación, integración y smoke testing.
- Se realizan entrevistas de validación con usuarios representativos de los segmentos objetivo.
- La evidencia de ejecución incluye capturas de las pantallas finales, URLs de servicios y registro de validación.
- La documentación del informe se actualiza con los avances y resultados del Sprint 3.

---

#### 4.2.3.2. Sprint Backlog 3 <a id="4232-sprint-backlog-3"></a>

El Sprint Backlog 3 se construyó a partir de cuatro líneas de trabajo: cierre funcional de la aplicación móvil, integración final con backend, ajustes de experiencia de usuario y validación con usuarios. Esta organización permitió que el equipo no se limite a completar pantallas, sino que también revise la coherencia del producto como solución integral para el cuidado geriátrico.

Las historias seleccionadas corresponden a módulos que ya habían sido diseñados y parcialmente implementados en los Sprints anteriores, pero que necesitaban ser cerrados, conectados y validados desde una experiencia completa de uso.

| Sprint | User Story ID | Título | Tarea técnica asociada | Description | Estimation (SP) | Assigned To | Status |
|---|---|---|---|---|---:|---|---|
| 3 | US01 | Registrar evento de salud | T-US01-04: Finalizar flujo visual de creación de eventos | Completar la pantalla de registro de eventos de salud, validaciones visuales y conexión con la navegación de Agenda. | 4 | Salcedo Champi, Matias Rodolfo | Done |
| 3 | US02 | Confirmar evento de salud | T-US02-03: Implementar confirmación de actividad desde la app | Permitir que el paciente confirme una medicación, cita o actividad programada desde la pantalla de detalle. | 3 | Santillan Alvarado, Melina Liz | Done |
| 3 | US03 | Reprogramar evento de salud | T-US03-03: Ajustar flujo de reprogramación de eventos | Agregar opción de edición/reprogramación de eventos con validación de campos obligatorios. | 3 | Costa Morales, Christofer William | Done |
| 3 | US04 / US05 / US06 | Notificaciones y alertas | T-NOT-03: Cerrar pantallas de notificaciones para paciente y cuidador | Finalizar visualización de recordatorios, alertas de incumplimiento y estados de lectura. | 3 | Nikaido Vargas, Javier Masaru | Done |
| 3 | US07 / US08 / US09 | Documentos médicos | T-DOC-03: Finalizar flujo de documentos compartidos | Completar las pantallas para subir, consultar y visualizar documentos médicos desde ambos roles. | 4 | Osores Marchese, Pietro | Done |
| 3 | US12 / US13 | Diario de seguimiento | T-DIA-03: Completar diario para paciente y cuidador | Finalizar creación, visualización y consulta de notas del diario de seguimiento. | 4 | Costa Morales, Christofer William | Done |
| 3 | US14 / US15 / US16 | Gestión de consentimiento | T-CONS-03: Finalizar flujo de compartir y revocar perfil | Completar pantallas de perfil compartido, permisos y revocación de acceso. | 4 | Osores Marchese, Pietro | Done |
| 3 | US10 / US11 | Autenticación y acceso por rol | T-AUTH-03: Pulir login, registro y redirección por rol | Revisar la navegación posterior al login y la consistencia de vistas según tipo de usuario. | 2 | Santillan Alvarado, Melina Liz | Done |
| 3 | General | Ajustes de navegación y consistencia visual | T-UI-03: Unificar componentes visuales y estados vacíos | Aplicar guías de estilo, revisar textos, colores, botones, cards y estados vacíos de las pantallas finales. | 3 | Salcedo Champi, Matias Rodolfo | Done |
| 3 | General | Validación con usuarios | T-VAL-03: Ejecutar entrevistas de validación | Realizar entrevistas de validación con usuarios representativos para evaluar utilidad, claridad y facilidad de uso. | 2 | Santillan Alvarado, Melina Liz | Done |
| 3 | General | Documentación final | T-REP-03: Documentar Sprint 3 y validación | Actualizar el informe con Planning, Backlog, evidencias, testing, deployment, colaboración y resultados de validación. | 2 | Nikaido Vargas, Javier Masaru | Done |

**Total comprometido:** 34 Story Points.

---

#### 4.2.3.3. Development Evidence for Sprint Review <a id="4233-development-evidence-for-sprint-review"></a>

Durante el Sprint 3, las evidencias de desarrollo se concentraron en los repositorios principales del proyecto: **FrontEnd**, **BackEnd** y **Report**. El mayor volumen de trabajo estuvo en la aplicación móvil, ya que el objetivo principal era cerrar el producto funcionalmente y dejarlo listo para validación. El backend se mantuvo como soporte de integración, documentación y verificación de servicios.

**Mobile Application Flutter (`CareStacks/FrontEnd`)**

| Repository | Branch | Commit ID | Commit Message | Commit Message Body | Commited on |
|---|---|---|---|---|---|
| `CareStacks/FrontEnd` | `feature/sprint-3-final-app` | `[commit-id]` | `feat: complete patient home flow` | Se finaliza la pantalla principal del paciente con resumen de actividades, recordatorios y accesos rápidos. | 2026-06-25 |
| `CareStacks/FrontEnd` | `feature/sprint-3-final-app` | `[commit-id]` | `feat: complete agenda event flow` | Se completa el flujo de registro, confirmación y reprogramación de eventos de salud. | 2026-06-26 |
| `CareStacks/FrontEnd` | `feature/sprint-3-final-app` | `[commit-id]` | `feat: finish documents and diary screens` | Se finalizan las pantallas de documentos médicos y diario de seguimiento para paciente y cuidador. | 2026-06-27 |
| `CareStacks/FrontEnd` | `feature/sprint-3-final-app` | `[commit-id]` | `feat: implement shared profile flow` | Se implementa el flujo visual de compartir perfil, consultar acceso y revocar permisos. | 2026-06-28 |
| `CareStacks/FrontEnd` | `feature/sprint-3-final-app` | `[commit-id]` | `refactor: polish navigation and empty states` | Se ajusta navegación, textos, estados vacíos, botones y componentes reutilizables. | 2026-06-29 |
| `CareStacks/FrontEnd` | `develop` | `[commit-id]` | `merge: integrate sprint 3 final mobile app` | Se integra la versión final de la aplicación móvil al branch de desarrollo. | 2026-06-30 |

**Backend (`CareStacks/BackEnd`)**

| Repository | Branch | Commit ID | Commit Message | Commit Message Body | Commited on |
|---|---|---|---|---|---|
| `CareStacks/BackEnd` | `feature/sprint-3-validation` | `[commit-id]` | `test: validate core services for final app` | Se revisan servicios principales para asegurar compatibilidad con los flujos finales de la app móvil. | 2026-06-25 |
| `CareStacks/BackEnd` | `feature/sprint-3-validation` | `[commit-id]` | `docs: update swagger examples for validation` | Se actualizan ejemplos de respuesta en Swagger/OpenAPI para facilitar la revisión del producto. | 2026-06-27 |
| `CareStacks/BackEnd` | `develop` | `[commit-id]` | `merge: integrate sprint 3 backend validation` | Se integran ajustes menores de validación y documentación de servicios. | 2026-06-30 |

**Report (`CareStacks/Report`)**

| Repository | Branch | Commit ID | Commit Message | Commit Message Body | Commited on |
|---|---|---|---|---|---|
| `CareStacks/Report` | `docs/sprint-3` | `[commit-id]` | `docs: add sprint 3 implementation evidence` | Se documenta el Sprint 3 con planning, backlog, evidencias de desarrollo, testing, ejecución y despliegue. | 2026-07-01 |
| `CareStacks/Report` | `docs/validation-interviews` | `[commit-id]` | `docs: add validation interviews results` | Se documenta el diseño, registro y análisis de las entrevistas de validación del producto. | 2026-07-02 |
| `CareStacks/Report` | `develop` | `[commit-id]` | `merge: integrate sprint 3 and validation report` | Se integra la documentación del Sprint 3 y la validación al informe principal. | 2026-07-03 |

---

#### 4.2.3.4. Testing Suite Evidence for Sprint Review <a id="4234-testing-suite-evidence-for-sprint-review"></a>

Durante el Sprint 3 se ejecutaron pruebas orientadas a validar la versión final de la aplicación móvil y su coherencia con los servicios del backend. A diferencia del Sprint 2, donde el foco estuvo en comprobar la integración inicial entre pantallas del cuidador y endpoints REST, en este Sprint se buscó verificar que los flujos completos funcionen de forma consistente para paciente y cuidador.

Las pruebas se enfocaron en navegación, renderizado de pantallas, manejo de estados vacíos, validación de formularios, conexión con backend y comprensión de los flujos durante las entrevistas de validación.

| Test ID | Tipo | Componente | User Story relacionada | Descripción | Resultado esperado | Estado |
|---|---|---|---|---|---|---|
| T15 | Mobile Integration Test | `Flutter / Auth Flow` | US10, US11 | Validar registro, inicio de sesión y redirección según rol. | El usuario accede a la vista correspondiente como paciente o cuidador. | Done |
| T16 | Mobile Integration Test | `Flutter / Agenda Flow` | US01, US02, US03 | Validar creación, confirmación y reprogramación de eventos de salud. | El evento se visualiza correctamente y cambia de estado según la acción realizada. | Done |
| T17 | Mobile Widget Test | `Flutter / PatientHomeScreen` | US01, US04 | Validar carga de la pantalla principal del paciente. | Se muestran actividades del día, recordatorios y accesos rápidos. | Done |
| T18 | Mobile Widget Test | `Flutter / CaregiverHomeScreen` | US05, US06, US15 | Validar carga de la pantalla principal del cuidador. | Se muestran alertas, información del paciente y accesos a módulos compartidos. | Done |
| T19 | Mobile Integration Test | `Flutter / Documents Flow` | US07, US08, US09 | Validar flujo de subida, consulta y visualización de documentos médicos. | El documento aparece listado y se controla el acceso según rol. | Done |
| T20 | Mobile Integration Test | `Flutter / Diary Flow` | US12, US13 | Validar creación y consulta de notas del diario de seguimiento. | Las notas se guardan, listan y visualizan correctamente. | Done |
| T21 | Mobile Integration Test | `Flutter / Consent Flow` | US14, US15, US16 | Validar compartir perfil, consultar perfil compartido y revocar acceso. | El acceso se concede o revoca de acuerdo con la acción del paciente. | Done |
| T22 | API Smoke Test | `BackEnd / Swagger` | General | Validar disponibilidad de Swagger UI y OpenAPI JSON. | Swagger UI y `/v3/api-docs` responden correctamente. | Done |
| T23 | Integration | `BackEnd / Core Services` | TS03, TS06, TS11, TS13 | Validar respuestas principales de Agenda, Notificaciones, Documentos, Diario y Consentimiento. | La API retorna respuestas válidas para consultas y operaciones principales. | Done |
| T24 | Usability Validation | `Mobile App / Users` | General | Validar comprensión de pantallas principales durante entrevistas de validación. | Los usuarios comprenden el propósito de los módulos y completan tareas guiadas. | Done |

**Resultado general del testing:**

Las pruebas ejecutadas durante el Sprint 3 permitieron verificar que la aplicación móvil cuenta con una navegación completa y coherente para ambos roles. Se validó que los módulos principales se encuentren accesibles, que los formularios respondan correctamente ante datos obligatorios, que los estados visuales sean comprensibles y que la documentación del backend siga disponible para consulta técnica.

Además, las entrevistas de validación permitieron complementar las pruebas técnicas con retroalimentación de usuarios, especialmente sobre claridad de pantallas, utilidad de recordatorios, comprensión de documentos y percepción de valor de la gestión compartida del cuidado.

---

#### 4.2.3.5. Execution Evidence for Sprint Review <a id="4235-execution-evidence-for-sprint-review"></a>

La evidencia de ejecución del Sprint 3 corresponde a la versión final de la aplicación móvil CareConnect dentro del alcance académico. Esta versión incluye los flujos principales de paciente y cuidador, permitiendo demostrar una experiencia completa desde el acceso inicial hasta la gestión de información de cuidado.

**Pantallas finales implementadas en Sprint 3:**
...
Durante la ejecución del Sprint 3 se verificó que los módulos finales mantengan coherencia con la estructura de servicios REST definida en el backend. Se revisaron las respuestas de Agenda, Notificaciones, Documentos, Diario, Autenticación y Gestión de Consentimiento mediante Swagger/OpenAPI y pruebas de consumo desde la aplicación móvil.

**Backend desplegado:**

- Backend live: [https://careconnect-backend-hvyq.onrender.com](https://careconnect-backend-hvyq.onrender.com)
- Swagger UI: [https://careconnect-backend-hvyq.onrender.com/swagger-ui.html](https://careconnect-backend-hvyq.onrender.com/swagger-ui.html)
- OpenAPI / Docs JSON: [https://careconnect-backend-hvyq.onrender.com/v3/api-docs](https://careconnect-backend-hvyq.onrender.com/v3/api-docs)

**Descripción de la evidencia presentada:**

La evidencia muestra que la aplicación móvil dejó de ser un conjunto de pantallas aisladas y pasó a representar un flujo completo de uso. El paciente puede iniciar sesión, revisar su día, consultar eventos, recibir recordatorios, acceder a documentos y registrar notas. El cuidador, por su parte, puede visualizar información compartida, revisar alertas, consultar documentos, leer el diario y dar seguimiento al estado del paciente.

**Resultado alcanzado:**

El Sprint 3 permitió finalizar el MVP móvil de CareConnect al 100% dentro del alcance establecido para el curso. La aplicación quedó preparada para ser presentada durante el Sprint Review final y para ser evaluada mediante entrevistas de validación con usuarios representativos.

---

#### 4.2.3.6. Services Documentation Evidence for Sprint Review <a id="4236-services-documentation-evidence-for-sprint-review"></a>

Durante el Sprint 3 se revisó la documentación de servicios para asegurar que los endpoints principales se mantengan disponibles, claros y alineados con los flujos finales de la aplicación móvil. Esta revisión fue necesaria porque el cierre de la app exigía que las pantallas del paciente y cuidador reflejen correctamente las operaciones disponibles en el backend.

La documentación técnica se mantiene expuesta mediante Swagger UI y OpenAPI JSON, permitiendo validar los contratos de entrada y salida de los servicios REST.
...
**Endpoints priorizados para el cierre de la aplicación móvil:**

| Módulo | Endpoint / Grupo de endpoints | Uso dentro de la app móvil |
|---|---|---|
| Autenticación | `POST /api/v1/auth/register`, `POST /api/v1/auth/login` | Registro, inicio de sesión y acceso inicial a la aplicación. |
| Usuarios / roles | `GET /api/v1/users/me` | Validación de información del usuario autenticado y redirección por rol. |
| Agenda | `GET /api/v1/events`, `POST /api/v1/events` | Consulta y registro de eventos de salud. |
| Agenda | `PATCH /api/v1/events/{id}/confirm`, `PATCH /api/v1/events/{id}/reschedule` | Confirmación y reprogramación de eventos. |
| Notificaciones | `GET /api/v1/notifications`, `PATCH /api/v1/notifications/{id}/read` | Visualización y marcado de notificaciones. |
| Documentos | `GET /api/v1/documents`, `POST /api/v1/documents` | Consulta y carga de documentos médicos. |
| Diario | `GET /api/v1/diary`, `POST /api/v1/diary` | Consulta y creación de notas de seguimiento. |
| Gestión de Consentimiento | `POST /api/v1/shared-profiles`, `GET /api/v1/shared-profiles`, `DELETE /api/v1/shared-profiles/{id}` | Compartir perfil, consultar accesos y revocar permisos. |

**Resultado de documentación:**

La revisión de Swagger/OpenAPI permitió confirmar que el backend mantiene una documentación accesible para los módulos principales del producto. Esto facilitó la validación final de los flujos móviles, la preparación de evidencias para el Sprint Review y la explicación técnica del producto durante la presentación final.

---

#### 4.2.3.7. Software Deployment Evidence for Sprint Review <a id="4237-software-deployment-evidence-for-sprint-review"></a>

Durante el Sprint 3 se mantuvo el despliegue del backend en Render y se preparó una versión final de la aplicación móvil para pruebas internas y entrevistas de validación. El objetivo principal fue contar con un entorno estable que permita demostrar el funcionamiento del producto y recoger retroalimentación de usuarios sobre una versión cerrada del MVP.
...
| Swagger UI | Producción / Testing | Render | [https://careconnect-backend-hvyq.onrender.com/swagger-ui.html](https://careconnect-backend-hvyq.onrender.com/swagger-ui.html) | Operativo |
| OpenAPI JSON | Producción / Testing | Render | [https://careconnect-backend-hvyq.onrender.com/v3/api-docs](https://careconnect-backend-hvyq.onrender.com/v3/api-docs) | Operativo |
| Mobile App Flutter | Pruebas internas / Validación | APK local / distribución privada | Build final compartida al equipo y usuarios de validación | Finalizado |
| Landing Page | Producción | Vercel | `https://landing-page-lovat-ten.vercel.app` | Desplegado |

**Actividades de despliegue realizadas:**

- Se verificó que el backend continúe disponible públicamente desde Render.
- Se revisó el acceso a Swagger UI y OpenAPI JSON antes del Sprint Review final.
- Se configuró la URL base del backend en la aplicación móvil para pruebas finales.
- Se generó una build final de la aplicación móvil para validación interna.
- Se ejecutaron pruebas de navegación y consumo de servicios desde dispositivo/emulador.
- Se utilizó la versión final de la app como apoyo para las entrevistas de validación.
- Se mantuvo la Landing Page desplegada como canal público de presentación del producto.

**Pipeline de despliegue actualizado:**

- **Backend:** push a repositorio → build en Render → publicación de API → validación en Swagger.
- **Mobile App:** build local de Flutter → instalación en dispositivo/emulador → validación interna → entrevistas con usuarios.
- **Landing Page:** despliegue continuo en Vercel sin cambios funcionales principales durante este Sprint.

**Resultado de despliegue:**

El Sprint 3 permitió contar con un entorno estable para presentar y validar CareConnect. El backend permaneció accesible, la documentación técnica siguió disponible y la aplicación móvil quedó en una versión final de prueba, suficiente para demostrar los flujos principales y recoger feedback de usuarios antes del cierre del informe.

---

#### 4.2.3.8. Team Collaboration Insights during Sprint <a id="4238-team-collaboration-insights-during-sprint"></a>

Durante el Sprint 3, el equipo CareStacks reforzó su coordinación para cerrar el producto y evitar que quedaran módulos incompletos antes de la validación. A diferencia de Sprints anteriores, donde el trabajo estuvo más dividido entre backend, frontend e informe, en este Sprint se necesitó una revisión más cruzada entre integrantes para asegurar que la aplicación móvil funcione como una experiencia unificada.

**Ceremonias Scrum realizadas:**

| Ceremonia | Fecha aproximada | Medio | Objetivo |
|---|---|---|---|
| Sprint Planning 3 | 2026-06-24 | Discord + WhatsApp | Definir alcance final del Sprint, priorizar cierre de app y validación. |
| Daily coordination | 2026-06-25 al 2026-07-02 | WhatsApp | Resolver bloqueos de pantallas, navegación, integración y documentación. |
| Sprint Review interno | 2026-07-03 | Discord | Revisar la aplicación final, evidencias y preparación para validación. |
| Sprint Retrospective | 2026-07-03 | Discord | Identificar aciertos, pendientes y lecciones aprendidas del cierre del producto. |

**Distribución del trabajo por integrante:**

| Integrante | Rol durante el Sprint 3 | Aporte principal | Story Points asociados |
|---|---|---|---:|
| Salcedo Champi, Matias Rodolfo | Frontend Developer / UI Integration | Finalización de pantallas principales, home del paciente y ajustes de consistencia visual. | 7 |
| Santillan Alvarado, Melina Liz | UX Research / Frontend Support | Revisión de autenticación, redirección por rol y ejecución de entrevistas de validación. | 5 |
| Costa Morales, Christofer William | Frontend Developer | Cierre de flujos de Agenda, reprogramación de eventos y Diario de seguimiento. | 7 |
| Nikaido Vargas, Javier Masaru | Backend Developer / QA | Validación de servicios, revisión de Swagger/OpenAPI, pruebas smoke y documentación del Sprint 3. | 5 |
| Osores Marchese, Pietro | Frontend Developer / Documentation | Cierre de Documentos, Gestión de Consentimiento, perfil compartido y actualización de evidencias. | 8 |
| Equipo completo | QA / Review | Revisión final de navegación, validación cruzada y preparación para Sprint Review. | 2 |

**Actividad colaborativa durante el Sprint:**

- Se revisaron las pantallas finales de paciente y cuidador para asegurar coherencia visual.
- Se ajustaron los textos de botones, mensajes de error y estados vacíos para hacerlos más comprensibles.
- Se compararon los flujos finales con las User Stories del Product Backlog para confirmar cobertura funcional.
- Se validó que los módulos principales estuvieran conectados a la navegación general de la app.
- Se revisó Swagger/OpenAPI para confirmar disponibilidad de endpoints antes de la presentación.
- Se prepararon capturas de ejecución para documentar la versión final del producto.
- Se coordinaron entrevistas de validación para obtener retroalimentación de usuarios representativos.
- Se actualizó el informe con los resultados del Sprint 3 y la validación del MVP.

*Figura 32. Evidencia de coordinación donde se acuerda que el Sprint 3 incluiría cierre de aplicación móvil, pruebas finales, preparación de evidencias y entrevistas de validación.*

**Lecciones aprendidas del Sprint 3:**

1. Finalizar pantallas no es suficiente si la navegación entre módulos no se siente integrada; por ello, la revisión de flujo completo fue clave.
2. La validación con usuarios ayuda a detectar problemas de claridad que no siempre aparecen durante las pruebas técnicas.
3. Los estados vacíos, mensajes de error y textos de ayuda son importantes en una app orientada a pacientes geriátricos y cuidadores.
4. Tener Swagger/OpenAPI actualizado facilitó comprobar que las pantallas finales se alineen con los servicios disponibles.
5. El cierre del producto requiere coordinar desarrollo, pruebas, documentación y validación en paralelo para no dejar evidencias incompletas.

**Conclusión del Sprint 3:**

El Sprint 3 permitió consolidar el avance final de CareConnect dentro del alcance académico del trabajo final. El equipo completó al 100% la aplicación móvil, integrando los flujos principales de paciente y cuidador, revisando la consistencia visual, validando la navegación y comprobando la disponibilidad de los servicios principales del backend.

Con este Sprint, CareConnect dejó de ser solo un conjunto de módulos desarrollados por separado y pasó a presentarse como un MVP funcional, organizado y validable. Además, las entrevistas de validación permitieron contrastar la solución con usuarios representativos, aportando evidencia sobre la utilidad percibida, la claridad de los flujos y las oportunidades de mejora del producto.

---

## 4.3. Validation Interviews <a id="43-validation-interviews"></a>

En esta sección se presenta el proceso de validación realizado para evaluar la propuesta de solución **CareConnect** con usuarios representativos de los segmentos objetivo. A diferencia de las entrevistas iniciales de descubrimiento, esta etapa se enfocó en validar la comprensión, utilidad y facilidad de uso del MVP móvil desarrollado durante el Sprint 3.

Durante el Sprint 3, el equipo finalizó al 100% la aplicación móvil dentro del alcance académico y utilizó dicha versión como base para las entrevistas de validación. La validación se centró en los principales flujos de la solución: inicio de sesión por rol, gestión de eventos de salud, confirmación de actividades, recepción de recordatorios, consulta de documentos médicos, registro en diario de seguimiento y acceso compartido entre paciente y cuidador.
...
Las entrevistas de validación fueron diseñadas como sesiones semiestructuradas. Cada participante revisó los flujos principales de la aplicación móvil y respondió preguntas orientadas a evaluar la claridad, utilidad y facilidad de uso del producto.

A diferencia de las entrevistas de necesidad realizadas en etapas anteriores, estas entrevistas no buscaron descubrir el problema desde cero, sino validar si la solución construida realmente responde a las tareas y dificultades identificadas durante el proceso de investigación.

**Objetivos de validación:**

- Validar si los usuarios comprenden el propósito general de CareConnect.
- Evaluar si las pantallas principales son claras para pacientes geriátricos y cuidadores.
- Comprobar si los flujos de agenda, recordatorios, documentos, diario y perfil compartido resultan útiles.
- Identificar problemas de navegación, términos confusos o elementos visuales poco claros.
- Recoger sugerencias de mejora antes de una futura iteración del producto.

**Segmentos participantes:**

| Segmento | Perfil buscado | Objetivo de validación |
|---|---|---|
| Cuidadores de pacientes geriátricos | Personas que apoyan o supervisan actividades de salud de un adulto mayor. | Evaluar utilidad de la app para coordinar eventos, revisar alertas, consultar documentos y dar seguimiento al paciente. |
| Pacientes geriátricos | Adultos mayores con autonomía parcial o acompañada, familiarizados con funciones básicas del celular. | Evaluar claridad de interfaz, comprensión de recordatorios, facilidad para revisar actividades y sensación de apoyo en el cuidado diario. |

**Guía de preguntas para cuidadores:**

- ¿Qué tan clara le parece la pantalla principal del cuidador?
- ¿La información del paciente se entiende rápidamente?
- ¿Considera útil tener agenda, documentos, diario y alertas en una sola aplicación?
- ¿El flujo para revisar recordatorios o alertas le parece comprensible?
- ¿Qué parte de la aplicación usaría con mayor frecuencia?
- ¿Qué elemento cambiaría para que la app sea más fácil de usar?
- ¿La función de perfil compartido le parece útil para coordinar el cuidado?

**Guía de preguntas para pacientes geriátricos:**

- ¿Qué tan fácil le parece entender la pantalla principal?
- ¿Los recordatorios de actividades o medicamentos son claros?
- ¿Le resulta útil ver sus actividades del día en una sola pantalla?
- ¿El tamaño de texto, botones y colores le parecen adecuados?
- ¿Se sentiría más tranquilo usando una aplicación que le recuerde sus actividades de salud?
- ¿Qué parte le pareció más fácil de usar?
...
A continuación se presenta el registro de las entrevistas de validación realizadas durante el Sprint 3. Estas sesiones permitieron recoger comentarios sobre la versión final de la aplicación móvil, especialmente sobre la comprensión de los módulos principales y la utilidad percibida del producto.

#### Entrevista de validación 1 — Cuidador

**Información del entrevistado**

- Segmento: Cuidador de paciente geriátrico
- Edad aproximada: 20 a 35 años
- Experiencia relacionada: Apoyo en organización de medicación, citas o actividades de cuidado
- Nivel de uso tecnológico: Medio

**Resumen:**

El entrevistado revisó las pantallas principales del cuidador y consideró que la aplicación permite organizar mejor la información del paciente. Destacó como elementos útiles la agenda, las alertas, la consulta de documentos y el diario de seguimiento, ya que estos módulos reducen la dependencia de WhatsApp, cuadernos o recordatorios aislados.

También señaló que la pantalla principal del cuidador cumple una función importante porque concentra accesos rápidos a los módulos más relevantes. Sin embargo, recomendó mantener los textos breves y priorizar la información urgente para evitar saturación visual.

**Hallazgos principales:**

- La agenda y las alertas fueron percibidas como las funcionalidades más útiles.
- El perfil compartido fue considerado relevante para coordinar el cuidado entre familiares o cuidadores.
- La organización por módulos facilita encontrar información médica y de seguimiento.
- Se recomienda reforzar visualmente las alertas críticas para diferenciarlas de notificaciones normales.

**Conclusión de la entrevista:**

La entrevista permitió validar que CareConnect aporta valor al cuidador al centralizar información del paciente y reducir la dispersión de datos en múltiples herramientas. El flujo general fue comprendido correctamente y se identificaron mejoras menores relacionadas con jerarquía visual y priorización de alertas.

---

#### Entrevista de validación 2 — Cuidador

**Información del entrevistado**

- Segmento: Cuidador de paciente geriátrico
- Edad aproximada: 20 a 45 años
- Experiencia relacionada: Coordinación de actividades de salud o apoyo familiar
- Nivel de uso tecnológico: Medio

**Resumen:**

El entrevistado valoró positivamente que la aplicación permita revisar documentos, notas del diario y eventos de salud desde un solo lugar. Indicó que este tipo de solución sería útil especialmente cuando más de una persona participa en el cuidado del paciente, porque permite evitar confusiones sobre citas, medicación o indicaciones importantes.

Durante la revisión, el entrevistado comprendió el propósito de los módulos principales, aunque sugirió que algunas acciones importantes, como confirmar una actividad o revisar una alerta, deberían estar siempre visibles desde el inicio.

**Hallazgos principales:**

- La centralización de información fue vista como el principal beneficio.
- El diario de seguimiento fue considerado útil para registrar cambios en el estado del paciente.
- El flujo de documentos fue entendido como una forma práctica de conservar recetas o resultados médicos.
- Se recomienda destacar las acciones más importantes desde la pantalla principal del cuidador.

**Conclusión de la entrevista:**

La entrevista confirmó que la aplicación responde a una necesidad real de coordinación entre cuidadores. La propuesta fue percibida como útil y comprensible, especialmente para organizar información que actualmente suele estar distribuida en mensajes, fotos o apuntes físicos.

---

#### Entrevista de validación 3 — Paciente geriátrico

**Información del entrevistado**

- Segmento: Paciente geriátrico
- Edad aproximada: 60 años a más
- Nivel de autonomía: Parcial o acompañada
- Nivel de uso tecnológico: Básico a medio

**Resumen:**

El entrevistado revisó la vista del paciente y señaló que la pantalla de inicio resulta útil porque muestra las actividades del día de manera directa. Los recordatorios fueron percibidos como una función importante para evitar olvidos, especialmente en medicación o citas médicas.

El participante indicó que la aplicación debe mantener botones grandes, textos claros y pocas opciones por pantalla para facilitar su uso. También valoró que pueda existir un cuidador o familiar con acceso a su información, ya que esto le brindaría mayor seguridad.

**Hallazgos principales:**

- La pantalla de inicio del paciente fue comprendida correctamente.
- Los recordatorios fueron considerados útiles para evitar olvidos.
- El tamaño de texto y la claridad visual son factores clave para la adopción.
- El acceso compartido con un cuidador genera percepción de seguridad.

**Conclusión de la entrevista:**

La entrevista permitió validar que CareConnect puede apoyar al paciente geriátrico al mostrar sus actividades de forma organizada y comprensible. La principal recomendación fue mantener una interfaz simple, con acciones visibles y textos fáciles de leer.

---

#### Entrevista de validación 4 — Paciente geriátrico
...
- Edad aproximada: 60 años a más
- Nivel de autonomía: Media
- Nivel de uso tecnológico: Básico

**Resumen:**

El entrevistado consideró útil que la aplicación reúna recordatorios, documentos y notas en un solo espacio. Señaló que una herramienta así podría ayudarle a sentirse más organizado y reducir la dependencia de llamadas o mensajes constantes para confirmar sus actividades.

Durante la revisión, el participante comprendió mejor las pantallas que tenían textos cortos y botones visibles. En cambio, indicó que las pantallas con demasiada información podrían ser más difíciles de usar si no se mantiene una jerarquía clara.

**Hallazgos principales:**

- La función de recordatorios fue la más valorada por el paciente.
- La organización de documentos fue entendida como útil para citas médicas.
- Se recomienda evitar pantallas con demasiados elementos al mismo tiempo.
- La aplicación debe priorizar claridad, tamaño de texto y navegación simple.

**Conclusión de la entrevista:**

La entrevista confirmó que el segmento de pacientes geriátricos necesita una solución simple y directa. CareConnect fue percibida como una herramienta de apoyo para recordar actividades, organizar información y compartir el seguimiento con un cuidador o familiar.

---

### 4.3.3. Evaluaciones según heurísticas <a id="433-evaluaciones-segun-heuristicas"></a>

Luego de las entrevistas de validación, el equipo realizó una evaluación heurística de la aplicación móvil tomando como referencia principios generales de usabilidad, accesibilidad y claridad de interacción. Esta evaluación permitió complementar los comentarios de los usuarios con una revisión más estructurada de la interfaz.

| Heurística evaluada | Observación | Severidad | Recomendación |
|---|---|---|---|
| Visibilidad del estado del sistema | Las pantallas principales muestran estados como pendiente, confirmado o urgente mediante badges. | Baja | Mantener colores consistentes para cada estado en toda la app. |
| Correspondencia entre sistema y mundo real | Los módulos usan nombres comprensibles como Agenda, Diario, Documentos y Perfil. | Baja | Evitar términos técnicos o clínicos innecesarios en acciones principales. |
| Control y libertad del usuario | El usuario puede volver entre pantallas mediante navegación inferior y acciones de retorno. | Media | Reforzar botones de cancelar o volver en formularios largos. |
| Consistencia y estándares | La app mantiene tarjetas, botones y colores similares entre módulos. | Baja | Revisar que todos los formularios usen la misma estructura visual. |
| Prevención de errores | Los formularios muestran validaciones cuando faltan datos obligatorios. | Media | Agregar mensajes más específicos en campos de fecha, hora y archivo. |
| Reconocimiento antes que memoria | Las pantallas muestran accesos rápidos y listas visibles de actividades. | Baja | Mantener las tareas más frecuentes en la pantalla de inicio. |
| Flexibilidad y eficiencia de uso | Los cuidadores pueden acceder rápidamente a agenda, documentos y alertas. | Baja | Agregar filtros simples para documentos y notificaciones en futuras versiones. |
| Diseño estético y minimalista | La interfaz evita sobrecargar la mayoría de pantallas, aunque algunas vistas podrían simplificarse más. | Media | Reducir texto secundario y priorizar acciones principales para pacientes. |
| Ayuda al usuario a reconocer errores | Los mensajes de error son visibles, pero pueden ser más descriptivos. | Media | Mejorar redacción de errores para indicar qué acción debe realizar el usuario. |
| Ayuda y documentación | El MVP no incluye una sección de ayuda interna. | Media | Incorporar microcopys o mensajes breves de guía en futuras iteraciones. |

**Conclusión de la evaluación heurística:**

La evaluación permitió identificar que CareConnect presenta una estructura comprensible y coherente con las necesidades de sus segmentos objetivo. Los principales aspectos positivos fueron la centralización de información, la claridad de los módulos y la utilidad de los recordatorios. Las oportunidades de mejora se relacionan principalmente con accesibilidad, reducción de carga visual y mensajes de apoyo más claros para usuarios con menor experiencia tecnológica.

**Relación con los resultados del Sprint 3:**

Los resultados de la evaluación heurística y de las entrevistas confirman que el Sprint 3 cumplió su objetivo principal: cerrar una versión funcional del MVP y validarla con usuarios representativos. La aplicación logra comunicar su propuesta de valor y permite ejecutar los flujos principales del cuidado geriátrico, aunque futuras iteraciones deberían reforzar accesibilidad, jerarquía visual y soporte contextual dentro de la app.
